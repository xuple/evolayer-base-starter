...
return [
    ...
    */
    ...
    | router-backed diagnostic-eligible probe candidates — exercisable via the broad diagnostic commands
    ...
    | likewise diagnostic-eligible but blocked / pending re-verification for ThreadStudio while its
