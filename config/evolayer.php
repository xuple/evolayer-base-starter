...
return [
    'base' => [
        ...
        // Brand surface for the published public explainer (evolayer/base) and
        // head metadata. Hosts rebrand by overriding these via env or by sharing
        // evolayer.base.brand on the Inertia props (see Support\EvoLayerProps) —
        // so resync never needs to overwrite the page file to rebrand it.
        'brand' => [
