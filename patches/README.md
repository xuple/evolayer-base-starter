...
**Verification:** Live-tested end-to-end where provider streaming currently works via `php artisan evolayer:ai:stream-smoke {provider}`:
...
from `php artisan evolayer:ai:stream-smoke anthropic`. The package command tests
